...
#include "ui_terminalsettingsdialog.h"
...
TerminalSettingsDialog::TerminalSettingsDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TerminalSettingsDialog)
{
    ui->setupUi(this);
...
TerminalSettingsDialog::Settings TerminalSettingsDialog::settings() const
{
    return currentSettings;
}

void TerminalSettingsDialog::showPortInfo(int idx)
{
    if (idx != -1) {
...
void TerminalSettingsDialog::apply()
{
    updateSettings();
    hide();
}

void TerminalSettingsDialog::checkCustomBaudRatePolicy(int idx)
{
...
void TerminalSettingsDialog::fillPortsParameters()
{
...
void TerminalSettingsDialog::fillPortsInfo()
{
...
void TerminalSettingsDialog::updateSettings()
{
